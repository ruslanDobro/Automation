...
public class GoogleSearchTest {
    ...
    String resultsStatsTextValue; // string from results element generated by a search engine
    @Test
    public void test001() {
        ...
        String selector = ".gLFyf"; // css selector to identify web element
        String resultVerify  = "result-stats"; // id for the  search results element
